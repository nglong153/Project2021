<template>
  <v-row>
    ...
    <v-col cols="12" md="12">
      <choose-location-card @choosed="setLocation" :detailView="true"></choose-location-card>
    </v-col>
    <v-col cols="12" md="12">
      <v-btn @click="handleViewDetail" color="primary">Xem chi tiết về khu vực này</v-btn>
    </v-col>
    <v-slide-y-transition mode="out-in">
      <v-col cols="12" md="12" v-show="showDetail">
        <span>Bạn đang xem khu vực {{ locationString }}</span>
        <v-spacer></v-spacer>
      </v-col>
    ...
    <v-slide-y-transition mode="out-in">
      <v-col cols="12" md="6" v-show="showDetail">
        <v-card>
          <v-card-title>
              ...
              >
                <div class="d-flex align-center flex-grow-1 flex-wrap">
                  <div class="me-auto pe-2">
                    ...
                    <span class="text-xs"
                      >{{ data.areaValue }} - {{ data.textPrice }}. {{ data.metaDescription }}
                    </span>
                  </div>
                </div>
              </v-list-item>
      ...
      listPosts: [
        {
          ...
          metaDescription:
            'Xem nhanh tin rao hay nhất về Mua/ Bán Nhà Đất tại Quận Hai Bà Trưng Thành phố Hà Nội Vị trí hấp dẫn Quận Hai Bà Trưng, Hà Nội, bán nhà dt 133 m2 liên hệ trực tiếp để được tư vấn',
        ...
        },
        {
          ...
          title:
            'Ở Đường Đê Trần Khát Chân, Quận Hai Bà Trưng, bán nhà, bán ngay với giá tốt bất ngờ 3.5 tỷ có dt 45 m2 ,căn này bao gồm 3 PN hỗ trợ mọi thủ tục miễn phí',
          metaDescription:
            'Tìm hiểu ngay tin rao mới nhất về Mua/ Bán Nhà Đất tại Quận Hai Bà Trưng Thành phố Hà Nội Ở Đường Đê Trần Khát Chân, Quận Hai Bà Trưng, bán nhà, bán ngay với giá tốt bất ngờ 3.5 tỷ có dt 45 m2 ,căn này bao gồm 3 PN hỗ trợ mọi thủ tục miễn phí',
        ...
        },
        {
          ...
          title:
            'Nằm tại Phường Phố Huế, Hà Nội, bán nhà, vào ở ngay giá phải chăng chỉ 3.5 tỷ có dt chung là 50 m2 ,nhà này có tổng 3 phòng ngủ liên hệ chính chủ',
          metaDescription:
            'Xem đầy đủ loạt tin đăng giá trị về Mua/ Bán Nhà Đất tại Quận Hai Bà Trưng Thành phố Hà Nội Nằm tại Phường Phố Huế, Hà Nội, bán nhà, vào ở ngay giá phải chăng chỉ 3.5 tỷ có dt chung là 50 m2 ,nhà này có tổng 3 phòng ngủ liên hệ chính chủ',
          longitude: '105.8656789',
          latitude: '21.0069151',
          type: 1,
          projectId: null,
        ...
        },
        {
          ...
          title:
            'Bán nhà diện tích rộng 42 m2 vị trí đặt tọa lạc trên Phường Phố Huế, Hà Nội vào ở luôn giá cực mềm chỉ 3.6 tỷ ,tổng quan nhà này gồm 3 PN ,đường đi 3 m',
          metaDescription:
            'Xem ngay thông tin đỉnh cao nhất về Mua/ Bán Nhà Đất tại Quận Hai Bà Trưng Thành phố Hà Nội Bán nhà diện tích rộng 42 m2 vị trí đặt tọa lạc trên Phường Phố Huế, Hà Nội vào ở luôn giá cực mềm chỉ 3.6 tỷ ,tổng quan nhà này gồm 3 PN ,đường đi 3 m',
        ...
        },
        {
          ...
          title:
            'Tổng quan ngôi nhà này 4 PN, bán nhà giá cực tốt từ 35 tỷ dt 140 m2 vị trí mặt tiền tọa lạc ở Phố Phố Huế, Quận Hai Bà Trưng',
          metaDescription:
            'HOT!!! Xem ngay Mua/ Bán Nhà Đất tại Quận Hai Bà Trưng Thành phố Hà Nội Tổng quan ngôi nhà này 4 PN, bán nhà giá cực tốt từ 35 tỷ dt 140 m2 vị trí mặt tiền tọa lạc ở Phố Phố Huế, Quận Hai Bà Trưng',
